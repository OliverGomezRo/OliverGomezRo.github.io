...
Pelota.prototype.sense = function(environment){
  ...
  if((obsctaculo1.length > 0 && (obstaculo1[0].distance <= this.radio)) || 
     (obsctaculo2.length > 0 && (obstaculo2[0].distance <= this.radio)))
     this.colision=1;
  else
     this.colision=0;
};//Se pone punto y coma cuando es una asignación
